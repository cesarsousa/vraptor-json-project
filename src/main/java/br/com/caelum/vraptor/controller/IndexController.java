...
import br.com.caelum.vraptor.model.ContratanteEServico;
import br.com.caelum.vraptor.model.DireitoAoArquivo;
import br.com.caelum.vraptor.model.Endereco;
import br.com.caelum.vraptor.model.IndicacoesDiversas;
import br.com.caelum.vraptor.model.Pais;
import br.com.caelum.vraptor.model.ProtocoloMadri;
import br.com.caelum.vraptor.model.Representante;
import br.com.caelum.vraptor.model.Telefone;
import br.com.caelum.vraptor.model.TipoAplicacaoRegistroEnum;
...
public class IndexController {
	...
	@Consumes(value="application/json")
	@Get("/ws/gerar/documento/{codigoFormulario}")
	public void gerarFormulario(ProtocoloMadri protocoloMadri, String codigoFormulario) {
		
		//buildFormularioMock(protocoloMadri);
		
		result.use(json())
		.from(protocoloMadri)
		.include("titular")
		.include("direitoAoArquivo")
		.include("representante")
		.include("aplicacoesRegistros")
		.include("indicacoesDiversas")
		.include("bensEServicos")
		.include("contratantesEServicos")
		.include("designacoes")
		.serialize();	
				
	}
	
	private void buildFormularioMock(ProtocoloMadri protocoloMadri) {
		...
		bemEServico1.setServico("bens e serviços");
		BemEServico bemEServico2 = new BemEServico();
		bemEServico2.setClasse("classe b");
		bemEServico2.setServico("bens e serviços");		
		...
		contratanteEServico1.setDefinicaoClassesServicos("definição 1");
		...
		contratanteEServico2.setDefinicaoClassesServicos("definição 2");
